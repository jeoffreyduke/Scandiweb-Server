...
const descriptions_1 = require("./items/descriptions");
const attribute_set_1 = __importStar(require("./model/attribute-set"));
const attribute_1 = __importDefault(require("./model/attribute"));
const shoeSizes = new attribute_set_1.default('Size')
    .addItemList([
...
const clothesSizes = new attribute_set_1.default('Size')
    .addItemList([
...
const colors = new attribute_set_1.default('Color')
...
const yesNo = [new attribute_1.default('Yes'), new attribute_1.default('No')];
const capacity = new attribute_set_1.default('Capacity')
    .addItemList([
